# Build and Package PDF Viewer Widget
param(
...
# Paths
$projectPath = "C:\Users\ALPHA\source\repos\widgets\3SC.Widgets.PdfViewer"
$buildOutput = Join-Path $projectPath "bin\Release\net8.0-windows\publish"
$widgetKey = "pdf-viewer"
$communityFolder = Join-Path $env:APPDATA "3SC\Widgets\Community\$widgetKey"

Write-Host "Building PDF Viewer Widget..." -ForegroundColor Cyan
...
Write-Host "`nPDF Viewer Widget packaged successfully!" -ForegroundColor Green
